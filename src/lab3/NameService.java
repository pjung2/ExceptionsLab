...
*/
    public String extractLastName(String fullName)
    {
        ...
        {
            throw new InvalidNameException("Please enter your full name", new NullPointerException());
        }
        ...
        for (int i = 0; i < fullName.length(); i++)
        {
            ...
            {
                throw new InvalidNameException("Full Name cannot contain digits", new IllegalArgumentException());
            }
